...
export const products: Product[] = [
  ...
  {
    id: "meline-caucasian-skin-day",
    slug: "meline-caucasian-skin-day",
    name: "Caucasian Skin Day Serum",
    brand: "Meline",
    category: "Serum & Ampull",
    skinType: ["pigmentering"],
    price: 1449,
    size: "30 ml",
    tagline: "Aktivt dagserum för en jämnare hudton",
    description:
      "Caucasian Skin Day är ett aktivt dagserum som hjälper till att minska synligheten av ojämn hudton och mörka fläckar. Noggrant utvalda ingredienser arbetar i synergi för att både korrigera och förebygga en ojämn hudton. Anpassat för fototyp I-III.",
    keyIngredients: [
      "Mandelsyra",
      "Fytinsyra",
      "Kojicsyra",
    ...
    usage: "Applicera efter rengöring varje morgon. Massera in väl i huden.",
    imageUrl: "/products/meline-caucasian-skin-day.jpg",
    badges: ["Fototyp I-III"],
  },
  {
    id: "meline-caucasian-skin-night",
    slug: "meline-caucasian-skin-night",
    name: "Caucasian Skin Night",
    brand: "Meline",
    category: "Serum & Ampull",
    skinType: ["pigmentering"],
    price: 1599,
    size: "20 g",
    tagline: "Aktivt nattserum för synligt jämnare hud",
    description:
      "MeLine Caucasian Skin Night är ett mycket aktivt nattserum som bidrar till att korrigera synlig ojämn hudton och mörka fläckar samt förebygga nya ojämnheter. På längre sikt bidrar serumet även till en mjukare, slätare och fastare hud för ett friskare och sundare utseende. Anpassat för fototyp I-III.",
    keyIngredients: ["Azelainsyra", "Askorbinsyra", "Liponsyra", "Magnesiumsulfat", "Retinal"],
    usage: "Applicera varje kväll efter rengöring. Massera väl in i huden.",
    imageUrl: "/products/meline-caucasian-skin-night.jpg",
    badges: ["Fototyp I-III"],
  },
  {
    id: "meline-restore",
    slug: "meline-restore",
    name: "Restore Fuktighetskräm",
    brand: "Meline",
    category: "Kräm",
    skinType: ["torr", "kanslig"],
    price: 899,
    size: "30 g",
    tagline: "Rik kräm som stärker en försvagad hudbarriär",
    description:
      "MeLine Restore är en rik och fuktighetsgivande kräm som bidrar till att stärka en försvagad hudbarriär och reducera irritation. Den passar särskilt bra för torr hud och kompletterar MeLine Day och MeLine Night. Utvecklad för nordiskt klimat.",
    keyIngredients: ["Rosa rubiginosa", "Aloe vera", "Arnika", "Centella asiatica", "Glycyrrhetinsyra"],
    usage: "Applicera på rengjord hud efter MeLine Day eller MeLine Night.",
    imageUrl: "/products/meline-restore.jpg",
    badges: ["Barriärstärkande"],
  },
  {
    id: "meline-moist",
    slug: "meline-moist",
    ...
    price: 899,
    size: "30 ml",
    tagline: "Återfuktande serum med hyaluronsyra",
    description:
      "MeLine Moist är ett återfuktande serum med hyaluronsyra i olika molekylstorlekar. De fragmenterade molekylerna bidrar till att öka hudens fuktnivå i djupare lager, medan de större molekylerna bildar ett skyddande fuktlager på hudytan.",
    keyIngredients: ["Fragmenterad hyaluronsyra"],
    usage:
      "Applicera på rengjord hud efter MeLine Day eller MeLine Night, eller enligt din terapeuts instruktioner.",
    imageUrl: "/products/meline-moist.webp",
    badges: ["Fuktboost"],
  },
  {
    id: "meline-ethnic-skin-night",
    slug: "meline-ethnic-skin-night",
    name: "Ethnic Skin Night",
    brand: "Meline",
    category: "Serum & Ampull",
    skinType: ["pigmentering"],
    price: 1599,
    size: "20 g",
    tagline: "Aktivt nattserum för fototyp IV-VI",
    description:
      "MeLine Ethnic Skin Night är ett mycket aktivt nattserum som bidrar till att korrigera synlig ojämn hudton och mörka fläckar samt förebygga nya ojämnheter. På längre sikt bidrar serumet även till en mjukare, slätare och fastare hud för ett friskare och sundare utseende. Anpassat för fototyp IV-VI.",
    keyIngredients: [
      "Mandelsyra",
      "Askorbinsyra",
      "Alpha-arbutin",
    ...
    usage:
      "Applicera varje kväll efter rengöring. Massera väl in i huden och följ din terapeuts anvisning.",
    imageUrl: "/products/meline-ethnic-skin-night.png",
    badges: ["Fototyp IV-VI"],
  },
  {
    id: "meline-ethnic-skin-day",
    slug: "meline-ethnic-skin-day",
    name: "Ethnic Skin Day Serum",
    brand: "Meline",
    category: "Serum & Ampull",
    skinType: ["pigmentering"],
    price: 1449,
    size: "30 ml",
    tagline: "Aktivt dagserum för fototyp IV-VI",
    description:
      "MeLine Ethnic Skin Day är ett aktivt dagserum som hjälper till att minska synligheten av ojämn hudton och mörka fläckar. Noggrant utvalda ingredienser arbetar i synergi för att både korrigera och förebygga en ojämn hudton. Anpassat för fototyp IV-VI.",
    keyIngredients: ["Fytinsyra", "Pyrudruvsyra", "Glutation", "Salicylsyra", "Undecylenoyl"],
    usage:
      "Applicera efter rengöring varje morgon. Massera in väl i huden och följ din terapeuts instruktioner. Ska inte användas av gravida eller ammande.",
    imageUrl: "/products/meline-ethnic-skin-day.png",
    badges: ["Fototyp IV-VI"],
  },
  {
